          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="flex flex-col gap-12">
              <div className="flex flex-col gap-8">
                <Fadein delay={60}>
                  <div className="inline-flex items-center gap-2.5 ps-5 py-2.5 border border-primary/30 bg-primary/10 rounded-full w-fit">
                ...
                <div className="grid grid-cols-3 gap-8">
                  {ABOUT_STATS.map((stat, index) => (
                    <div key={index} className="relative">
                      <div className="absolute -inset-s-4 top-0 w-2 h-full bg-linear-to-b from-primary via-primary/50 to-primary/20 rounded-full"></div>
              ...
              <Fadein delay={400}>
                ...
                >
                  <Download className="size-5 group-hover:translate-y-0.5 transition-transform duration-300" />
                  Download Resume
                </button>
              </Fadein>
            </div>
