    ...
    <>
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 inset-s-1/4 size-96 bg-primary/20 opacity-20 rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 inset-e-1/4 size-96 bg-primary/20 opacity-20 rounded-full blur-3xl" />
          <div className="absolute top-1/2 inset-s-1/2 -translate-x-1/2 -translate-y-1/2 size-96 bg-primary/10 opacity-20 rounded-full blur-3xl" />
        </div>
