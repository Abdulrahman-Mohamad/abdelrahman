    ...
    <>
      <section id="contact" className="relative py-20 bg-black overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 inset-s-1/4 size-96 bg-primary/20 opacity-30 rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 inset-e-1/4 size-96 bg-primary/20 opacity-30 rounded-full blur-3xl" />
          <div className="absolute top-1/2 inset-s-1/2 -translate-x-1/2 -translate-y-1/2 size-96 bg-primary/10 opacity-30 rounded-full blur-3xl" />
        </div>
          ...
          <Fadein delay={0}>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-white/60 max-w-2xl mx-auto">
                Have a project in mind? Let's discuss how we can bring your idea
                to life.
              </p>
            </div>
          </Fadein>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={5}
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300 resize-none"
                    ...
                    {Object.entries(SOCIAL_LINKS)
                      ...
                      .map(([platform, url]) => {
                        ...
                        return Icon ? (
                          ...
                          >
                            <Icon className="size-6 text-white/60 group-hover:text-primary transition-colors" />
                          </a>
                        ) : null;
                      })}
                  </div>
