    ...
    <>
      <footer className="relative bg-black overflow-hidden border-t border-white/10">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 inset-s-1/4 size-96 bg-primary/10 opacity-30 rounded-full blur-3xl" />
          <div className="absolute bottom-0 inset-e-1/4 size-96 bg-primary/10 opacity-30 rounded-full blur-3xl" />
        </div>
                ...
                <ul className="space-y-3">
                  {NAV_LINKS.map((link) => (
                    <li key={link.id}>
                      ...
                      >
                        <div className="size-1.5 rounded-full bg-white/30 group-hover:bg-primary group-hover:w-2 transition-all duration-300" />
                ...
                <div className="flex flex-wrap gap-3">
                  {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                    ...
                    return Icon ? (
                      ...
                      >
                        <Icon className="size-5 text-white/60 group-hover:text-primary transition-colors duration-300" />
